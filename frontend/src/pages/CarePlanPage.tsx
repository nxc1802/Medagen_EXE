...
interface LifestyleItem { title: string; icon: string; tips: string[] }
interface NutritionInclude { name: string; desc: string; icon: string }
interface NutritionAvoid { name: string; badge: string; badgeColor: 'red' | 'amber' }
interface OTCSuggestion { name: string; desc: string; icon: string }

interface CarePlan {
  id: string; summary: string; conditions: string[]
  lifestyle: LifestyleItem[]
  nutrition: { include: NutritionInclude[]; avoid: NutritionAvoid[] }
  exercise: { recommended: string[]; avoid: string[] }
  otc_suggestions: OTCSuggestion[]
  next_checkup_days: number; next_checkup_date?: string; created_at?: string
}
